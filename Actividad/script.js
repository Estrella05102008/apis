...
function mostrarEdades(personas){
    ...
    personas.forEach(personas => console.log(persona.edad));
}
...
function mayoresDeEdad(personas){
    ...
    const mayoresDeEdad = personas.filter(persona => persona.edad > 20);
...
function minDosHobbies(personas){
    ...
    const hobbies = personas.filter(persona => persona.hobby.lenght >= 2);
